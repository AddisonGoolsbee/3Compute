    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-8">
      <div className="max-w-[460px] w-full bg-paper-elevated border border-rule rounded-xl p-12 shadow-md">
        ...
        <a
          ...
          className="bg-navy text-white border-0 px-5 py-3.5 rounded-md text-[15px] font-semibold inline-flex items-center gap-3 justify-center w-full shadow-cta cursor-pointer hover:brightness-105 hover:-translate-y-px transition-[transform,filter] duration-150 no-underline"
        >
