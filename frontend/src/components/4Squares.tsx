export default function FourSquares({ size = 23 }: { size?: number }) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" name="4 Squares Logo" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width={`${size}px`} height={`${size}px`} viewBox="0 0 122.88 122.566" enable-background="new 0 0 122.88 122.566" xmlSpace="preserve">
      <g fill="currentColor">
