...
LESSONS: list[dict] = [
    ...
    },
    {
        ...
        "overlays": [
            ("frontend/public/docs/weather-app/solution/weather_api.py", "weather_api.py"),
            ("frontend/public/docs/weather-app/solution/display.py", "display.py"),
        ],
    ...
    },
    {
        ...
        "overlays": [("frontend/public/docs/debugging-workshop/solution.py", "buggy_programs.py")],
        "test": ["python3", "test_programs.py"],
    },
    {
        "id": "computing_layers",
        "template": "frontend/public/templateProjects/Computing-Layers",
        "overlays": [("frontend/public/docs/computing-layers/solution.py", "file_system.py")],
        "test": ["python3", "test_filesystem.py"],
    },
    {
        "id": "my_website",
        "template": "frontend/public/templateProjects/My-Website",
        "overlays": [("frontend/public/docs/my-website/solution/app.py", "app.py")],
